...
APIEndpoint = namedtuple('APIEndpoint', ['endpoint', 'arg_type'])
...
GET_IPSW_DOWNLOAD = APIEndpoint('/ipsw/download/{identifier}/{buildid}', APIEndpointArgType.IDENTIFIER_BUILDID)
GET_IPSW_INFO = APIEndpoint('/ipsw/{identifier}/{buildid}', APIEndpointArgType.IDENTIFIER_BUILDID)
...
GET_OTA_DOCS = APIEndpoint('/ota/documentation/{device}/{version}', APIEndpointArgType.DEVICE_VERSION)
GET_OTA_DOWNLOAD = APIEndpoint('/ota/download/{identifier}/{buildid}', APIEndpointArgType.IDENTIFIER_BUILDID)
GET_OTA_INFO = APIEndpoint('/ota/{identifier}/{buildid}', APIEndpointArgType.IDENTIFIER_BUILDID)
    ...
    try:
        match endpoint.arg_type:
            ...
            case APIEndpointArgType.DEVICE_VERSION:
                endpoint = endpoint.endpoint.format(device=kwargs['device'], version=kwargs['version'])
            ...
            case APIEndpointArgType.IDENTIFIER_BUILDID:
                endpoint = endpoint.endpoint.format(identifier=kwargs['identifier'], buildid=kwargs['buildid'])
